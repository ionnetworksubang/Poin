...
// Fungsi Anti-Patah (Mencegah bug spasi/kutip pada tombol Edit)
...
// UPDATE: FUNGSI CLOSE MODAL MENUTUP SEMUA JENIS MODAL
function closeModal() { 
...
// ==========================================
// FITUR BARU: UPLOAD LAPORAN MASAL (PARSER)
// ==========================================
...
async function processBulkLaporan() {
    ...
    blocks.forEach(block => {
        ...
        // Pastikan nama dan CID minimal ada
        if (nama && cid) {
